<nav x-data="{ open: false }" class="bg-white/90 backdrop-blur-md border-b border-gray-100/50 sticky top-0 z-50 transition-all duration-300">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.about.edit')" :active="request()->routeIs('admin.about.edit')" class="text-emerald-950 font-bold border-b-2 hover:text-emerald-600">
                        {{ __('Tentang Kami') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-emerald-50 bg-white/50 backdrop-blur-xl">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.about.edit')" :active="request()->routeIs('admin.about.edit')" class="font-bold">
                {{ __('Tentang Kami') }}
            </x-responsive-nav-link>
